              ...
              <View style={[styles.formSection, { minHeight: H * 0.45 }]}>
                ...
                <Animated.View style={{ opacity: cardOpacity, transform: [{ translateY: cardY }, { translateX: cardShakeX }], paddingHorizontal: rs(28), paddingTop: 16 }}>
                  <Animated.View style={{ opacity: headerOpacity, transform: [{ translateY: headerY }] }}>
                    ...
                    <Text style={[styles.welcomeSubtitle, { color: colors.textSecondary }]}>Sign in to your shared space</Text>
                  </Animated.View>
                  ...
                  <Animated.View style={{ opacity: bottomOpacity }}>
                    ...
                    {statusMsg && (
                      <View style={[styles.statusPill, { borderColor: colors.borderWarning, backgroundColor: colors.bgWarning }]}>
                        <Text style={[styles.statusText, { color: colors.textAccent }]}>{statusMsg}</Text>
                      </View>
                    )}
                    ...
                    <Link href="/(auth)/register" asChild>
                      <TouchableOpacity style={styles.signupLink}>
                        <Text style={[styles.signupText, { color: colors.textSecondary }]}>
                          Don't have an account? <Text style={[styles.signupTextBold, { color: colors.accent }]}>Sign Up</Text>
                        </Text>
                      </TouchableOpacity>
                    </Link>
                  </Animated.View>
